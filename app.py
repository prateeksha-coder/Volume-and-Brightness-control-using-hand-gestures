#py -3.10 -m pip install mediapipe (mediapipe doesn't work on python 3.13 pr higher. Recommend using 3.10)
#py -3.10 -m pip install pycaw
#py -3.10 -m pip install screen-brightness-control
